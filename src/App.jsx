...
import mfj from './assets/mfj.png'
import teammed from './assets/teammed.png'
...
function App() {
    ...
    const [typeEffect] = useTypewriter({
        words : ["Full Stack Developer","Coder","Software Developer"],
        loop : {},
        typeSpeed : 100,
        delaySpeed : 20
    })
            ...
            {isLoading ? ( <Loader />) :(
                <div className="bg-neutral-100 dark:bg-black">
                    <div className="relative">
                        <img className="w-full h-auto" src={cover} id="start" />
                        <h1 className="head absolute text-[1.5rem] font-bold text-gray-200 top-[47%] left-[10%] md:top-[30%] md:left-[10%] md:text-[2.4rem]">Hi <span className="text-red-600 text-[1.5rem] md:text-[2.4rem]">I'm</span></h1>
                        <h1 className="head absolute text-[1.5rem] text-gray-200 top-[58%] left-[10%] md:top-[38%] md:left-[10%] md:text-[2.4rem]">Rajesh Balasubramaniam</h1>
                        <h1 className="absolute text-[1.5rem] text-gray-200 font-black top-[69%] left-[10%] md:top-[45%] md:left-[10%] md:text-[2.4rem]"><span>{typeEffect}</span></h1>
                        <div className='absolute top-[83%] left-[10%] md:top-[53%] md:left-[10%]'>
                            <a href="#_" className="relative inline-flex items-center justify-center p-2 px-1 py-1 overflow-hidden font-medium text-white transition duration-300 ease-out border-2 border-red-600 rounded-full shadow-md group md:px-6 md:py-3">
                    ...
                    <div>
                        <img className="hidden md:block md:absolute md:left-[10%] md:top-[0.5%] md:w-20 md:mt-1" src={rb} alt="..." />  
                        <ul className="hidden navbar font-bold md:text-white md:absolute md:left-[35%] md:top-[4%] md:flex md:flex-row md:items-center md:gap-[2vw]">
                            <li>
                                <a className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-red-600 hover:border-white dark:hover:text-red-600" href="#journey">About Me</a>
                            </li>
                            <li>
                                <a className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-red-600 hover:border-white dark:hover:text-red-600" href="#about">Services</a>
                            </li>
                            <li>
                                <a className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-red-600 hover:border-white dark:hover:text-red-600" href="#services">Projects</a>
                            </li>
                            <li>
                                <a className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-red-600 hover:border-white dark:hover:text-red-600" href="#project">Skills</a>
                            </li>
                            <li>
                                <a className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-red-600 hover:border-white dark:hover:text-red-600" href="#skills">Journey</a>
                            </li>
                            <li>
                                <a className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-red-600 hover:border-white dark:hover:text-red-600" href="#certi">Certifications</a>
                            </li>
                            <li>
                                <a className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-red-600 hover:border-white dark:hover:text-red-600" href="#social">Contact Me</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <button className="absolute top-[4%] left-[90%] z-16 md:absolute md:left-[94%] md:top-[4.7%]" onClick={toggleTheme}>
                    ...
                    <div data-aos="fade-up" className="relative" id="about">
                        <img className="w-[50%] h-[80%] ml-2 mt-10 rounded-md shadow-lg shadow-red-600 md:ml-[17%] md:w-[25%]" src={about} />
                        <div className="absolute top-[-8%] left-[56%] md:top-7 md:left-[50%]">
                            <h1 className="title text-[2.4rem] text-black dark:text-white">About <span className="text-[2.4rem] text-red-600">Me</span></h1>
                            <p className="content text-[0.75rem] text-black dark:text-white mr-2 md:mr-8 md:text-[1.5rem] md:text-justify">
                    ...
                    <div data-aos="fade-up" className="relative">
                        <img className="w-[46%] ml-2 mt-[25%] rounded-md shadow-lg shadow-red-600 md:mt-10 md:ml-[17%] md:w-[23%]" src={pic} />
                        <div className="content absolute top-[-35%] left-[56%] md:top-3 md:left-[50%]">
                                ...
                                {showEducation ? ( 
                                    <ul className=''>
                                        <li className="mb-4 ml-6 md:mb-10">            
                                            ...
                                            <p className="mt-2 text-[0.75rem] md:text-[1.3rem]">St.Raphaels Cathedral School</p>
                                        ...
                                        <li className="mb-4 ml-6 md:mb-10">
                                            ...
                                            <p className="text-[0.75rem] md:text-[1.3rem] mt-2">Karnakiyamman Higher Secondary School</p>
                                        ...
                                        <li className="mb-10 ml-6">
                                            ...
                                            <h3 className="font-bold leading-tight text-red-600 text-[0.75rem] md:text-[1.3rem]">BE.Electronics And Communication Engineering</h3>
                                            <p className="text-[0.75rem] md:text-[1.3rem] mt-2">2019-2023, CGPA : 7.9</p>
                                            <p className="text-[0.75rem] md:text-[1.3rem] mt-2">Nehru Institute Of Engineering And Technology</p>
                    ...
                    <h1 data-aos="fade-up" className="title text-black dark:text-white text-[2.4rem] mt-[30%] ml-[16%] md:mt-[15%] md:ml-[43%]" id="certi">My <span className='text-[2.4rem] text-red-600'>Certifications</span></h1>
                    <div data-aos="fade-up" className="container mx-auto p-4">
