                ...
                <div className="bg-white dark:bg-black">
                    ...
                    <div data-aos="fade-up" className="container mx-auto p-4">
                        <a href='https://certifications-ashen.vercel.app/' target='blank'>
                            <div className="content bg-white dark:bg-black text-black dark:text-white p-4 rounded-lg text-[.80rem] hover:scale-80 duration-1000 transform shadow shadow-red-600 md:text-[1.2rem]">
