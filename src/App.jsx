        ...
        <div>
            {isLoading ? ( <Loader />) :(
                <div className="bg-neutral-100 dark:bg-black">
                    ...
                    <h1 data-aos="fade-up" className="title text-black dark:text-white text-[2.4rem] mt-[25%] ml-[16%] md:mt-[15%] md:ml-[43%]" id="certi">My <span className='text-[2.4rem] text-red-600'>Certifications</span></h1>
                    <div data-aos="fade-up" className="container mx-auto p-4">
