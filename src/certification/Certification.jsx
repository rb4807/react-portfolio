const Certification = () => {
    ...
    return (
        <>
            <h1 data-aos="fade-up" className="title text-titleLight dark:text-titleDark text-[2.4rem] mt-[20%] text-center" id="certi">My <span className='text-[2.4rem] text-baseColor'>Certifications</span></h1>
