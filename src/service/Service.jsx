...
const ServiceCard = React.memo(({ service }) => (
    <div data-aos="fade-up" className="relative group">
        <div className="relative z-10 bg-gray-900/50 backdrop-blur-lg rounded-2xl p-4 border border-white/10 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl h-full flex items-center justify-center">
            ...
            <p className="text-center text-white text-sm font-semibold">{service}</p>
        </div>
    </div>
));
