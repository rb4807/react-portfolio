const Service = () => {
    ...
    return (
        <>
            <h1 data-aos="fade-up" className="title text-titleLight dark:text-titleDark text-[2.4rem] mt-[8%] ml-[30%] md:mt-[3%] md:ml-[43%]" id="services">My <span className='text-[2.4rem] text-baseColor'>Service</span></h1>
            <div data-aos="fade-up" className="container mx-auto p-4">
                <div className="content grid md:grid-cols-3 grid-cols-2 gap-4 text-contentLight dark:text-contentDark">
