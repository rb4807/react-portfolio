	...
	return (
		<div className="fixed inset-0 ">
			<div className="absolute inset-0">
				...
				<div ref={(ref) => (blobRefs.current[2] = ref)} className="absolute -bottom-8 left-[-40%] md:left-20 w-96 h-96 dark:bg-blue-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 md:opacity-20 "></div>
